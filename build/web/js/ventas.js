...
$("#prod").keyup(function (){
    ...
    $.get("vc",{"opc":1,"cod":cod},function(data) {
        ...
        if(x.stock==0){
            ...
            $("#tablaVentas").append("<tr><td><input type='text' id='cant' disabled='cant' value='0' class='form-control' style='width: 50px;'" +
            ...
            $("#tablaVentas").append("<tr><td><input type='text' id='cant' value='1' class='form-control' style='width: 50px;'" +
                "maxlength='3'></td><td>" + x.idprod + "</td><td>" + x.cod + "</td><td>" + x.nomprod + "</td><td>" + x.precio + "</td><td>" + x.stock + "</td><td>" +
                "<a href='#' id='validar'><i class='fas fa-cart-arrow-down fa-2x' style='color: #43d503;'></i></a></td></tr>");
             $("#visualizarProducto").css("display", "block");
